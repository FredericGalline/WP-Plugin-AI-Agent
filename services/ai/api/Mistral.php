...
/**
 * Client d'API pour communiquer avec le service Mistral AI
 *
 * Ce fichier contient une classe qui permet d'interagir avec l'API Mistral AI,
 * d'envoyer des requêtes formatées, et de traiter les réponses ou erreurs.
 * Il implémente les spécifications de l'API Mistral selon la documentation officielle.
 *
 * @package AI_Redactor
 ...
 *
 * @ai Ce fichier contient une classe qui gère exclusivement les communications HTTP avec l'API Mistral AI.
 * Sa responsabilité est strictement limitée à : (1) formater correctement les requêtes selon l'API Mistral,
 ...
 * servir de couche de transport entre le plugin WordPress et le service Mistral AI. Tous les détails
 * d'authentification et de formatage spécifiques à l'API Mistral sont encapsulés dans cette classe.
 */
...
/**
 * Classe pour interagir avec l'API Mistral
 */
class AI_Mistral_API
{
